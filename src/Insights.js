...
function renderInsights(data) {
  ...
  container.innerHTML = `
    <section class="overview">
      ...
      <div class="overview-box"><h2>Best Performer</h2><p>${
        best.symbol
      }</p></div>
      <div class="overview-box"><h2>Worst Performer</h2><p>${
        worst.symbol
      }</p></div>
          ...
          ${data
            .map((asset) => {
              ...
              <tr>
                ...
                <td class="${pl >= 0 ? "positive" : "negative"}">$${pl.toFixed(
                2
              )}</td>
...
if (assets.length === 0) {
  document.getElementById("insights-container").innerHTML =
    "<p style='color: red; font-weight: bold; font-size: 25px;'>Please Add an Asset first.</p>";
} else {
